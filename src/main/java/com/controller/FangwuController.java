    ...
    */
    ...
    public R save(@RequestBody FangwuEntity fangwu, HttpServletRequest request){
        ...
        Wrapper<FangwuEntity> queryWrapper = new EntityWrapper<FangwuEntity>()
            ...
            .eq("fangwu_louceng", fangwu.getFangwuLouceng())
            .eq("fangwu_danyuan", fangwu.getFangwuDanyuan())
            .eq("fangwu_fanghao", fangwu.getFangwuFanghao())
            .eq("fangwu_types", fangwu.getFangwuTypes())
            .eq("fangwu_loupan_types", fangwu.getFangwuLoupanTypes())
            .eq("huxing", fangwu.getHuxing())
            .eq("fangwu_jiegou", fangwu.getFangwuJiegou())
            .eq("fangwu_jianzhujiegou", fangwu.getFangwuJianzhujiegou())
            .eq("fangwu_zhuangxiu", fangwu.getFangwuZhuangxiu())
            .eq("fangwu_yongtu", fangwu.getFangwuYongtu())
            .eq("fangwu_fangben_types", fangwu.getFangwuFangbenTypes())
            .eq("fangwuzhuangtai_types", fangwu.getFangwuzhuangtaiTypes())
...
//                            fangwuEntity.setFangwuLouceng(data.get(0));                    //楼层 要改的
...
//                            fangwuEntity.setFangwuLoupanTypes(Integer.valueOf(data.get(0)));   //楼盘 要改的
//                            fangwuEntity.setHuxing(data.get(0));                    //户型 要改的
//                            fangwuEntity.setFangwuJiegou(data.get(0));                    //房屋结构 要改的
//                            fangwuEntity.setFangwuJianzhujiegou(data.get(0));                    //建筑结构 要改的
//                            fangwuEntity.setFangwuZhuangxiu(data.get(0));                    //装修情况 要改的
//                            fangwuEntity.setFangwuYongtu(data.get(0));                    //房屋用途 要改的
//                            fangwuEntity.setFangwuFangbenTypes(Integer.valueOf(data.get(0)));   //房本 要改的
//                            fangwuEntity.setFangwuClicknum(Integer.valueOf(data.get(0)));   //房屋热度 要改的
//                            fangwuEntity.setFangwuMianji(data.get(0));                    //房屋面积 要改的
//                            fangwuEntity.setFangwuJiage(data.get(0));                    //总价(万) 要改的
//                            fangwuEntity.setFangwuzhuangtaiTypes(Integer.valueOf(data.get(0)));   //房屋状态 要改的
//                            fangwuEntity.setFangwuContent("");//详情和图片
//                            fangwuEntity.setFangwuXiaoquContent("");//详情和图片
//                            fangwuEntity.setFangwuPeitaoContent("");//详情和图片
