...
public class HetongView extends HetongEntity implements Serializable {
	...
	* 合同类型的值
	*/
	@ColumnInfo(comment="合同类型的字典表值",type="varchar(200)")
	private String hetongValue;
	/**
	* 是否同意的值
	*/
	@ColumnInfo(comment="是否同意的字典表值",type="varchar(200)")
	private String yonghuTongyiValue;
	...
	* 获取： 是否同意的值
	*/
	public String getYonghuTongyiValue() {
		return yonghuTongyiValue;
	}
	/**
	* 设置： 是否同意的值
	*/
	public void setYonghuTongyiValue(String yonghuTongyiValue) {
		this.yonghuTongyiValue = yonghuTongyiValue;
	}
	...
	public String toString() {
		return "HetongView{" +
			...
			", yonghuTongyiValue=" + yonghuTongyiValue +
