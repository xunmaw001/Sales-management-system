...
//            fangwuYuyueEntity.setFangwuYuyueTypes();
//        }
        fangwuYuyueEntity.setFangwuYuyueShenheTime(new Date());//回复时间
...
//                            fangwuYuyueEntity.setFangwuYuyueUuidNumber(data.get(0));                    //预约编号 要改的
...
//                            fangwuYuyueEntity.setFangwuYuyueText(data.get(0));                    //预约缘由 要改的
//                            fangwuYuyueEntity.setInsertTime(date);//时间
//                            fangwuYuyueEntity.setFangwuYuyueTime(sdf.parse(data.get(0)));          //预约看房时间 要改的
//                            fangwuYuyueEntity.setFangwuYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //预约状态 要改的
//                            fangwuYuyueEntity.setFangwuYuyueYesnoText(data.get(0));                    //预约回复 要改的
//                            fangwuYuyueEntity.setFangwuYuyueShenheTime(sdf.parse(data.get(0)));          //回复时间 要改的
