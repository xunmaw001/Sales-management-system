    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="fangwuId" name="fangwuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="签订地点" prop="hetongAddress">
                       <el-input v-model="ruleForm.hetongAddress"
                                 placeholder="签订地点" clearable  :readonly="ro.hetongAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="签订地点" prop="hetongAddress">
                           <el-input v-model="ruleForm.hetongAddress"
                                     placeholder="签订地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="签订时间" prop="qiandingTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qiandingTime" label="签订时间" prop="qiandingTime">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info' && sessionTable=='users'"  label="是否同意" prop="yonghuTongyiTypes">
                        <el-select v-model="ruleForm.yonghuTongyiTypes" :disabled="ro.yonghuTongyiTypes" placeholder="请选择是否同意">
                            <el-option
                                v-for="(item,index) in yonghuTongyiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="是否同意" prop="yonghuTongyiValue">
                        <el-input v-model="ruleForm.yonghuTongyiValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_tongyi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuTongyiTypesOptions = data.data.list;
                    }
                });
